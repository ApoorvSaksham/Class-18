...
function setup(){
  ...
  iGround = createSprite(windowWidth/2,windowHeight-20,windowWidth,20);
...
if(score%500===0&&score>0){
  ...
  drawSprites();
  text("Score: " +score,50,windowHeight-250);

}

function spawnClouds(){
  if(frameCount%60===0){
  cloud = createSprite(windowWidth,windowHeight-180,40,20);
  cloud.y = Math.round(random(windowHeight-150,windowHeight-250));
  cloud.velocityX = -5;
  cloud.lifetime = 500;
...
function spawnObstacles(){
  if(frameCount%80===0){
    obstacle = createSprite(windowWidth,windowHeight-50,15,15);
